...
/**
 * Mandatory terms gate. Uses a site-local overlay (not VdModal) so Accept /
 * Decline are the only exits — VdModal always ships an Escape/X close path that
 * would look like “dismiss and browse.” Focus stays trapped in the panel.
 */
  ...
  >
    <div ref="panelRef" class="ts-consent-panel" tabindex="-1">
      <header class="ts-consent-header">
        ...
        <p class="ts-consent-version">Terms version {{ TOC_VERSION }}</p>
